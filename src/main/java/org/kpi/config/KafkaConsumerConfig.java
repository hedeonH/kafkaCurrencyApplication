...
public class KafkaConsumerConfig {
    ...
    @Value(value = "${kafka.consumer.group-id.sensor}")
    ...
    public ConsumerFactory<String, Sensor> sensorConsumerFactory() {
        ...
        props.put(
                ...
                sensorGroupId);
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(Sensor.class));
    }
    ...
    @Bean("NumberConsumer")
    public ConcurrentKafkaListenerContainerFactory<String, Integer> numberKafkaListenerContainerFactory() {
